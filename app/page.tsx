        ...
        <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 dark:from-slate-800 dark:via-blue-800 dark:to-slate-800">
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-2">Professional Cryptocurrency Trading Dashboard</p>
              <p className="text-sm text-blue-200/80">Real-time market data powered by Bithumb API</p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center justify-center py-20">
              <div className="text-center">
                <div className="inline-flex items-center space-x-3 bg-white dark:bg-gray-800 rounded-2xl px-6 py-4 shadow-lg">
                  ...
                  <span className="text-lg font-medium text-gray-700 dark:text-gray-200">Loading Market Data...</span>
                </div>
              </div>
            </div>
          }>
