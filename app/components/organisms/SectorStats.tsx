...
import {
  getConsolidatedSectors,
  SECTOR_PRIORITY,
} from "../../lib/crypto/consolidation";
...
export function SectorStats({ cryptos }: SectorStatsProps) {
  ...
  const positivePercentage = ((totalPositive / cryptos.length) * 100).toFixed(
    1
  );
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <span
                      className={`px-2 sm:px-3 py-1 sm:py-1.5 text-xs font-bold rounded-full ${
