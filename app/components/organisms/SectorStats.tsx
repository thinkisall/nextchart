          ...
          {sortedSectors.map(([sector, stats]) => {
            ...
            return (
              <button
                ...
                className="group relative overflow-hidden bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-white/20 dark:border-gray-700/30 p-5 hover:bg-white/70 dark:hover:bg-gray-800/70 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className={`px-3 py-1.5 text-xs font-bold rounded-full ${SECTOR_COLORS[sector] || 'bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300'}`}>
                      {sector}
                    </span>
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full group-hover:bg-blue-500 transition-colors"></div>
                    </div>
                  </div>
