  ...
  return (
    <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-gray-700/30 shadow-xl p-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        <button
          onClick={() => { setSortBy("change"); setSortOrder("desc"); }}
          className={`
            flex items-center justify-center space-x-2 px-4 py-3
            rounded-xl border transition-all duration-200 text-sm font-medium
        ...
        <button
          onClick={() => { setSortBy("change"); setSortOrder("asc"); }}
          className={`
            flex items-center justify-center space-x-2 px-4 py-3
            rounded-xl border transition-all duration-200 text-sm font-medium
        ...
        <button
          onClick={() => { setSortBy("volume"); setSortOrder("desc"); }}
          className={`
            flex items-center justify-center space-x-2 px-4 py-3
            rounded-xl border transition-all duration-200 text-sm font-medium
            ${sortBy === "volume"
