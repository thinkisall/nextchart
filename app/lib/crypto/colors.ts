...
export const SECTOR_COLORS: { [key: string]: string } = {
  ...
  "GameFi/NFT": "bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300",
  ...
  "NFT 마켓플레이스": "bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300",
  "NFT": "bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300",
