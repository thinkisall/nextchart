export const CRYPTO_SECTORS: { [key: string]: string } = {
  ...
  // 기타 및 상위 20위 코인 업데이트 (2025년 기준)
  ROA: "NFT/콘텐츠", // 로아코어 - NFT 및 디지털 콘텐츠 마켓플레이스, Art Tech 플랫폼
  OPEN: "AI", // 오픈렛저 - AI 블록체인, 데이터 수익화 플랫폼
  NCT: "보안", // 폴리스웜 - 블록체인 보안, 멀웨어 탐지 플랫폼
  ELX: "인프라/프라이버시", // 엘릭서 - 영지식 증명 기반 메시징 플랫폼
  SKY: "스테이블코인 연관 자산", // 스카이 프로토콜 - 탈중앙화 스테이블코인 발행 플랫폼
  D: "GameFi/NFT", // 달 오픈 네트워크 - P2E 게임 플랫폼, 마인즈 오브 달라니아 기반
  MAY: "게임", // 메이플로워 - 메이플스토리 기반 블록체인 게임
  ...
  LBL: "NFT/콘텐츠", // 레이블 에이아이 - NFT 기반 강의 저작권료 공유
